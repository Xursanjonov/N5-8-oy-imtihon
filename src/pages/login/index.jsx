...
const Login = () => {
    ...
    return (
        <section className='max-w-[1240px] w-full min-h-[550px] mx-auto flex items-center justify-center'>
            <form onSubmit={handleSubmit} className="w-[600px] h-[400px] mx-auto p-5 rounded-lg translate-y-[40%] border-[1px] shadow-md grid gap-3">
                <h2 className='text-4xl mb-3 text-black text-center font-bold'>Login</h2>
                ...
                <label htmlFor="button" className='w-full grid my-4'>
                    <button type='submit' className='w-full bg-black text-white text-xl px-2 font-semibold border-2 rounded-md'>Login</button>
                </label>
            </form>
        </section>
    )
